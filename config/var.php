...
$this->config['tables']['category'] = ['id_category','label',];

$this->config['tables']['category']['id'] = ['id_category'];

$this->config['tables']['owner'] = ['id_owner','last_name','frist_name','email','phone_number','nif','rccm','user',];

$this->config['tables']['category']['id'] = ['id_category'];$this->config['tables']['owner']['id'] = ['id_owner'];

$this->config['tables']['product'] = ['id_product','label','description','likes','times','url','category','shop',];
...
$this->config['tables']['shop'] = ['id_shop','label','owner',];
...
$this->config['tables']['users'] = ['id_user','last_name','first_name','email','phone_number','password_user','code',];
